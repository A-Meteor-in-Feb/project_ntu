...
data type other_properties_data from vehicle2tele.idl.
This example builds two applications, named vehicle2tele_publisher and
vehicle2tele_subscriber.
...
1. Launch Visual Studio in one of two ways:
        - By typing vehicle2tele-x64Win64VS2017.sln in the
          Command Prompt window.
        - By opening Visual Studio on your machine and then opening the
          vehicle2tele-x64Win64VS2017.sln file (in the
...
2. Select Build Solution from the Build menu. (You can also right-click
   vehicle2tele_publisher or vehicle2tele_subscriber and
...
To modify the data being sent: edit the vehicle2tele_publisher.cxx
file where it says 
...
1. Right-click vehicle2tele_publisher and choose Debug > Start new instance.
2. Right-click vehicle2tele_subscriber and choose Debug > Start new instance.
...
> objs\x64Win64VS2017\vehicle2tele_publisher.exe -d 0 -s 5
> objs\x64Win64VS2017\vehicle2tele_subscriber.exe -d 0 -s 5
