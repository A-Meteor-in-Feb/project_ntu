...
#ifndef vehicle2telePlugin_772184108_h
#define vehicle2telePlugin_772184108_h
...
NDDSUSERDllExport extern RTIBool 
GPSlocation_dataPlugin_deserialize(
    PRESTypePluginEndpointData endpoint_data,
    GPSlocation_data **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
NDDSUSERDllExport extern RTIBool 
other_properties_dataPlugin_deserialize(
    PRESTypePluginEndpointData endpoint_data,
    other_properties_data **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
#endif /* vehicle2telePlugin_772184108_h */
