...
data type control_data from tele2vehicle.idl.
This example builds two applications, named tele2vehicle_publisher and
tele2vehicle_subscriber.
...
1. Launch Visual Studio in one of two ways:
        - By typing tele2vehicle-x64Win64VS2017.sln in the
          Command Prompt window.
        - By opening Visual Studio on your machine and then opening the
          tele2vehicle-x64Win64VS2017.sln file (in the
...
2. Select Build Solution from the Build menu. (You can also right-click
   tele2vehicle_publisher or tele2vehicle_subscriber and
...
To modify the data being sent: edit the tele2vehicle_publisher.cxx
file where it says 
...
1. Right-click tele2vehicle_publisher and choose Debug > Start new instance.
2. Right-click tele2vehicle_subscriber and choose Debug > Start new instance.
...
> objs\x64Win64VS2017\tele2vehicle_publisher.exe -d 0 -s 10
> objs\x64Win64VS2017\tele2vehicle_subscriber.exe -d 0 -s 10
